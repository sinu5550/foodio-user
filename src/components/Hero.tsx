...
export default function Hero() {
  ...
  return (
    <section className=" relative overflow-hidden pt-32 pb-20  flex items-center justify-center">
      <div className="bg-brand-cream w-[45%] h-full rounded-bl-[260px] absolute -top-16 right-0" />
        ...
        <div className="flex flex-col gap-6 ">
          ...
          <div className="flex items-center gap-6 mt-1">
            <button
              ...
              className="flex items-center gap-3 bg-brand-green text-white px-8 py-4 rounded-tl-[30px] rounded-bl-[30px] rounded-br-[30px] rounded-tr-none text-[16px] font-semibold shadow-[0_20px_40px_-15px_rgba(26,60,52,0.4)] hover:bg-brand-green/90 transition-all group border-2 border-brand-green"
            >
              Order Now
              <ArrowRight
                size={22}
            ...
            <button
              ...
              className="px-12 py-4 rounded-tr-[30px] rounded-br-[30px] rounded-bl-[30px] rounded-tl-none border-2 border-brand-green text-brand-green text-[16px] font-semibold hover:bg-brand-green/5 transition-all"
            >
              View Menu
            </button>
          </div>
